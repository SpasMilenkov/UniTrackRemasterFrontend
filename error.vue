...
<template>
    <n-config-provider :theme="darkTheme">
        <n-space align="center" justify="center" class="min-h-screen bg-[hsl(240,8%,5%)]">
            <n-card class="w-full max-w-md mx-4 text-center">
                ...
                <n-p v-if="error.statusCode === 404" class="mb-6" > We're sorry, but the page you tried to access does not exist.</n-p>
                <n-p v-else class=" mb-6">We're sorry, but an error occurred while processing your request.</n-p>
