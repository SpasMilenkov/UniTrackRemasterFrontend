<template>
    <n-card :title="formType === 'create' ? 'Add Grade' : 'Edit Grade'" size="large" class="max-w-xl mx-auto p-4 flex">
        <n-form @submit.prevent="onSubmit">
            <!-- Student Information Section -->
            <n-divider>Student Information</n-divider>
            <n-space vertical>
                <n-form-item label="Student number" v-bind="studentNumberProps" path="studentNumber">
                    <n-input v-model:value="studentNumber" readonly />
                </n-form-item>
                <n-form-item label="Student name" v-bind="studentNameProps" path="studentName">
            ...
            <n-space justify="center">
                <n-button type="primary" attr-type="submit" size="large">Submit</n-button>
            </n-space>
        </n-form>
    </n-card>
</template>
...
import { DocumentTextOutline, PencilOutline, FileTrayStackedOutline, ChatbubbleOutline } from '@vicons/ionicons5'
...
//Form Fields
const [studentNumber, studentNumberProps] = defineField('studentNumber', naiveUiFormsConfig)
const [studentName, studentNameProps] = defineField('studentName', naiveUiFormsConfig)
const [grade, gradeProps] = defineField('grade', naiveUiFormsConfig)
const [gradeType, gradeTypeProps] = defineField('gradeType', naiveUiFormsConfig)
