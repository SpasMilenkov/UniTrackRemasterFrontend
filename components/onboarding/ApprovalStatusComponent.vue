                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="mb-6">
                                <div class="w-24 h-24 rounded-full flex items-center justify-center transition-all duration-300"
                                    ...
                                    <Icon v-if="onboardingStatus === 'pending'" name="eos-icons:three-dots-loading"
                                        class="text-yellow-400 text-5xl" />
                                    <Icon v-else-if="onboardingStatus === 'approved'"
                                        name="ic:baseline-check-circle-outline" class="text-emerald-400 text-5xl" />
                                    <Icon v-else name="material-symbols:check-circle" class="text-red-400 text-5xl" />
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <h2 class="text-2xl font-bold mb-4 bg-gradient-to-r text-transparent bg-clip-text capitalize"
                                    :class="{
                                        'from-yellow-400 to-yellow-600': onboardingStatus === 'pending',
                                        'from-emerald-400 to-blue-500': onboardingStatus === 'approved',
                                ...
                                <!-- Status Messages -->
                                <p v-if="onboardingStatus === 'pending'" class="text-gray-400 mb-6">
                                    Your application is being reviewed
                                </p>

                                <div v-if="onboardingStatus === 'approved'" class="flex flex-col items-center gap-6">
                                ...
                                <div v-if="onboardingStatus === 'rejected'" class="flex flex-col items-center gap-6">
                                    <p class="text-gray-400">
...
const mapNumberToStatus = (num: number): 'pending' | 'approved' | 'rejected' => {
...
watch(() => props.statusNumber, (newValue) => {
