    ...
    <div class="grades-table-wrapper">
        ...
        <div class="mb-4 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <n-input-group>
                    <n-input v-model:value="searchQuery" placeholder="Search subjects..." clearable class="w-64">
                        <template #prefix>
...
const filteredData = computed(() => {
    ...
    if (selectedTerm.value !== 'all') {
        const termKey = selectedTerm.value === 'first' ? 'firstTermGrade' : 'secondTermGrade'
