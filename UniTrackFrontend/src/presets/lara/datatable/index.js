export default {
    ...
    footer: {
        class: [
            ...
            // Shape
            'border-t-0 border-b border-x-0 rounded-b-md',
    ...
    column: {
        headercell: ({ context, props }) => ({
            class: [
                ...
                (props.sortable === '' || props.sortable) && context.sorted ? 'dark:text-white dark:bg-primary-900' : 'dark:text-white/80 dark:bg-surface-800',
                'border-surface-200 dark:border-surface-700 ',

                // States
                { 'hover:bg-surface-500 dark:hover:bg-surface-900': (props.sortable === '' || props.sortable) && !context?.sorted },
