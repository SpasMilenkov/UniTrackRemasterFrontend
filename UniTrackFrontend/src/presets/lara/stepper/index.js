    ...
    stepperpanel: {
        ...
        title: ({ context }) => ({
            class: [
                ...
                // Text
                context.active ? 'text-surface-900 dark:text-surface-0' : 'text-primary-200 dark:text-surface-00',
                'font-bold',
        ...
        separator: ({ context, state, parent }) => ({
            class: [
                ...
                parent.props.orientation === 'vertical' ? ['flex-none', 'h-auto'] : ['flex-1', 'w-full', 'h-[2px]', 'ml-4'],
        ...
        content: ({ parent }) => ({
            class: [parent.props.orientation === 'vertical' ? 'w-full' : '']
        })
    },
    panelcontainer: {
        class: [
