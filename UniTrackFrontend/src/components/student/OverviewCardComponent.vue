<template>
    <div class="flex items-center shadow-lg dark:shadow-none p-2 w-[30%] gap-8 flex-wrap rounded-md min-h-60 max-sm:min-w-[20rem] min-w-[36rem]"
        :class="cardContent.color">
        <Knob v-model="cardContent.value" readonly :min="cardContent.knobMinValue"
...
defineProps<{cardContent: OverviewCard}>()
</script>
<style scoped></style>