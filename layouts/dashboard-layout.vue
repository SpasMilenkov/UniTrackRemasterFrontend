<template>
  <div class="flex">
    ...
    <div
      v-if="!isMobile"
      class="fixed left-[240px] top-1/2 -translate-y-1/2 z-50 transition-all duration-300"
    ...
    >
      <n-button
        ...
        secondary
        size="small"
        class="transform -translate-x-1/2 shadow-lg hover:border-emerald-400"
...
const combinedMobileOptions = computed(() => [
  ...menuOptions,
  ...sidebarOptions,
]);
</script>
