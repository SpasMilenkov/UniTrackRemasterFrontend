  ...
  <div class="min-h-screen bg-[#101014] text-white">
    ...
    <div class="mx-auto px-6 lg:px-8 py-6">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <n-card
          class="bg-[#262629] hover:border-emerald-400/50 transition-all duration-300"
        >
          <template #header>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <div class="flex flex-col h-full">
            <div
              class="w-12 h-12 bg-emerald-400/10 rounded-full flex items-center justify-center mb-4 group-hover:bg-emerald-400/20 transition-all duration-300"
            >
