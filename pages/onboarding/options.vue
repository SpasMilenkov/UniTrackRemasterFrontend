<template>
  <div class="min-h-screen bg-[#101014] text-white relative">
    ...
    <div class="relative z-10">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="mx-auto max-w-3xl text-center">
            ...
            <p class="text-gray-400 max-w-2xl mx-auto">
              {{
                showSchoolOptions
                  ? `Start a new integration application or check the status of an
                            existing one`
                  : `Select the type of educational institution you want to integrate with
                            UniTrack`
              }}
            </p>
          </div>
      ...
      <div class="py-12">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          <div class="grid md:grid-cols-2 gap-8">
            <!-- Institution Type Selection Cards -->
            <template v-if="!showSchoolOptions">
              ...
              >
                <div class="flex flex-col h-full">
                  ...
                  <p class="text-gray-400 mb-6 flex-grow">
                    Transform your school's administrative processes with a
                    comprehensive solution designed specifically for K-12
                  ...
                  <n-button
                    ...
                    @click="showSchoolOptions = true"
                  >
                    Start School Integration
                    <template #icon>
              ...
              >
                <div class="flex flex-col h-full">
                  ...
                  <!-- Description -->
                  <p class="text-gray-400 mb-6 flex-grow">
                    Elevate your college or university's educational management
                    with our comprehensive platform designed for higher
                  ...
                  <n-button
                    ...
                    color="#4ade80"
                    class="text-lg w-full"
                    @click="navigateTo('/onboarding/university')"
                  >
                    Start Higher Ed Integration
                    <template #icon>
                      <Icon name="ph:arrow-right-bold" />
                    </template>
                  </n-button>
            ...
            <template v-else>
              ...
              >
                <div class="flex flex-col h-full">
                  ...
                  <!-- Description -->
                  <p class="text-gray-400 mb-6 flex-grow">
                    Begin your journey to transform your school's administrative
                    processes with UniTrack's comprehensive integration
                    solution.
                  </p>
                  ...
                  <n-button
                    ...
                    color="#4ade80"
                    class="text-lg w-full"
                    @click="navigateTo('/onboarding/school')"
                  >
              ...
              >
                <div class="flex flex-col h-full">
                  ...
                  <!-- Description -->
                  <p class="text-gray-400 mb-6 flex-grow">
                    Already started your integration process? Track your
                    application status and continue where you left off.
                  </p>
                  ...
                  <n-button
                    ...
                    color="#4ade80"
                    class="text-lg w-full"
                    @click="navigateTo('/onboarding/auth')"
                  >
                    Check Application Status
                    <template #icon>
                      <Icon name="ph:arrow-right-bold" />
      ...
      <!-- Back Button (only shown when viewing school options) -->
