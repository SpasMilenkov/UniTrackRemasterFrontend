<template>
    <n-space vertical :size="24" class="w-full max-w-[80rem] min-h-screen mx-auto px-4 py-16">
        ...
        <n-steps v-model:current="onboardingStore.currentStep" :readonly="true">
            ...
            <n-step title="Add school information"
        ...
        <ApprovalStatusComponent v-if="onboardingStore.currentStep === 2" title="Approval" :status-number="onboardingStore.applicationData?.status ?? 0" />
