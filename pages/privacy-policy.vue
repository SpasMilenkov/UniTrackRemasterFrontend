<template>
    ...
    <PolicyTemplate page-title="Privacy Policy" last-updated="November 4, 2024"> 
        ...
        <ul>
            ...
            <li>
                <p><strong>Website</strong> refers to UniTrack, accessible from <a href="www.unitrack.io"
                        rel="external nofollow noopener" target="_blank">www.unitrack.io</a></p>
            </li>
            <li>
        ...
        <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or
            ...
            You can learn more about cookies on <a href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies"
        ...
        <ul>
            <li>By visiting this page on our website: <a href="https://www.unitrack.io/contact"
                    rel="external nofollow noopener" target="_blank">https://www.unitrack.io/contact</a></li>
        </ul>
